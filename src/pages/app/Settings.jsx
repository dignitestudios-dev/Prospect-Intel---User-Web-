  ...
  return (
    <div className="min-h-screen bg-[#E9EEF7] flex flex-col xl:flex-row p-4 md:p-8">
      <div className="w-full xl:w-64 p-4 md:p-8 pt-0 xl:pt-0 mb-4 xl:mb-0">
        ...
        <div className="text-gray-700 font-medium mb-6 md:mb-10 text-sm md:text-base">
          {data?.email}
        </div>
        ...
        <div className="space-y-3">
          <button
            ...
            className={`w-full xl:w-[100px] text-left px-4 py-2 rounded-md shadow-sm border text-gray-700 font-medium ${
      ...
      <div className="flex-1 p-4 md:p-8 w-full xl:w-[980px] h-auto xl:h-[533px]">
        <div className="p-4 md:p-10 shadow-sm bg-transparent bg-opacity-25 pt-4 md:pt-8 rounded-xl border-2 border-white">
          {activeSection === "password" ? (
            <>
              ...
              <p className="text-gray-500 mb-6 text-sm md:text-base">
                To change your password, click the button below to request a
                password change.
              </p>

              <button
                className="w-full md:w-auto bg-[#0085CA] text-white px-5 py-3 rounded-xl hover:opacity-90"
