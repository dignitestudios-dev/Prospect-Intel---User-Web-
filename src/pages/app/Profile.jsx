...
import { FaHeart, FaUser, FaShieldAlt, FaBook, FaCheckCircle } from "react-icons/fa";
import { athletic, personal , football, features,other } from '../../assets/export';
import { SaveSuccessPopup, RequestSentPopup, SendMessageModal } from '../../components/PopupComponents';
    ...
    return (
        ...
        <div className="w-full min-h-screen bg-[#EAEEF8] font-sans p-4">
          ...
          {/* Conditional Popups/Modals */}
            {showSaveSuccess && <SaveSuccessPopup onClose={() => setShowSaveSuccess(false)} />}
            {showRequestSent && <RequestSentPopup onClose={() => setShowRequestSent(false)} />}
  ...
  <div className="border-gray-200 p-8 flex items-start">
    ...
    <div className="flex-1 flex justify-between">
      ...
      <div className="flex flex-col">
        ...
        {/* Name */}
        <h1 className="text-3xl font-extrabold text-gray-900">{p.name}</h1>
                    ...
                    <div className="w-[35%] bg-white bg-opacity-25 p-4 pt-4 rounded-xl border-2 border-white">
                               ...
                               <p className='text-black'>Parents</p> 
                                ...
                                {p.parents.map((parent, index) => (
                                    <div key={index} className="border-b last:border-b-0 pb-3 last:pb-0">
                                        <h4 className="font-bold text-gray-800 mb-1 mt-4">{parent.role}</h4>
                            ...
                            <div className="bg-white bg-opacity-25 p-4 pt-4 rounded-xl border-2 border-white mb-4">
                               ...
                               <p className='text-black'>Siblings</p> 
                                ...
                                {p.siblings.map((sibling, index) => (
                                    <div key={index} className="flex justify-between py-1 border-b last:border-b- mt-4">
                                        <span className="font-medium text-gray-800 text-sm">{sibling.name}</span>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="bg-white bg-opacity-25 p-4 pt-4 rounded-xl border-2 border-white">
                                ...
                                <p className="text-gray-700 text-sm italic mt-4">{p.keyInfluences}</p>
                            </div>
                        </div>
                    </div>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
    ...
    <div className="bg-[#0F0F0F] text-white p-10 rounded-xl shadow-lg">
      ...
      <p className="text-center text-sm opacity-90 leading-relaxed">
        ...
        Will clearly stand out amount his teammates. Strong positive influence.
        He will likely overcome potential deficiencies due to this outstanding component.
      </p>
    </div>
    ...
    <div className="bg-[#909090] text-white p-10 rounded-xl shadow-lg">
      ...
      <p className="text-center text-sm leading-relaxed opacity-90">
        Adequate/Blend In. Not necessarily a negative, but unlikely to be a positive.
        Average in all characteristics for the most part. This prospect possesses
        characteristics to survive and get by. He will not add or subtract to the culture.
        This will be the bulk of prospects.
      </p>
    </div>
  ...
  <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
    ...
    <div className="bg-black text-white rounded-xl p-6 flex flex-col items-center justify-center">
      ...
      <p className="mt-2 font-semibold text-lg">Elite</p>
              <p className='text-white text-[16px] text-center'>Displays solid overall character characteristics. Teammates and coaches will notice his positive traits during normal interactions with this player. Could overcome potential defeciencies in some areas</p>
    ...
    <div className="bg-[#F9C933] text-black rounded-xl p-6 flex flex-col items-center justify-center">
      ...
      <p className="mt-2 font-semibold text-lg">Character Deficiency</p>
                    <p className='text-black text-[16px] text-center'>Displays solid overall character characteristics. Teammates and coaches will notice his positive traits during normal interactions with this player. Could overcome potential defeciencies in some areas</p>
