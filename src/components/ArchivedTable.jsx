...
const ArchivedTable = ({
  ...
  const SortHeader = ({ label, sortKey, className = "" }) => {
    ...
    return (
      ...
      >
        <span
          className={`font-bold text-[12px] xl:text-[13px] tracking-wide transition-colors truncate ${isSorted ? "text-blue-600" : "text-gray-700 group-hover:text-blue-600"
            }`}
        >
          {label}
        </span>
        <span
          className={`flex items-center justify-center flex-shrink-0 transition-colors ${isSorted
        ...
        <div className="bg-white/30 rounded-xl p-4 mb-4">
          <label className="flex items-center gap-2">
            <input
              ...
              className="w-6 h-6 rounded-xl text-black bg-white border-2 border-gray-300 checked:bg-blue-600 checked:border-blue-600 focus:ring-2 focus:ring-blue-500"
            />
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                >
                  <Heart
                    size={18}
                    className={`transition-colors ${p.isSaved
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`flex items-center justify-center border-2 ${getGradeColor(p.athlete?.footballPiScore)} text-white rounded-xl font-bold text-[14px] px-2 py-1 min-w-[2rem]`}
                  >
                    {p.athlete?.footballPiScore || "--"}
                  </span>
                </div>
                <div className="flex justify-between items-center">
                  ...
                  <span
                    className={`flex items-center justify-center border-2 ${getGradeColor(p.athlete?.personalPiScore)} text-white rounded-xl font-bold text-[14px] px-2 py-1 min-w-[2rem]`}
                  >
                    {p.athlete?.personalPiScore || "--"}
                  </span>
                </div>
