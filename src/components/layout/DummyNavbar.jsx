      ...
      <div className="relative">
        <div className="hidden md:flex items-center gap-4">
          ...
          >
            ...
            <FaChevronDown
              className={`text-gray-500 text-[10px] ml-2 transition-transform ${
...
const MobileMenu = ({
  ...
  return (
    <div className="absolute right-0 top-full mt-2 w-80 bg-[#F5F7FB] rounded-xl shadow-2xl border border-gray-200 z-50 p-4">
      {/* Notifications */}
      {/* <NotificationDropdown
        noti={noti}
        handlePageChange={handlePageChange}
      ...
      <div className="space-y-1">
        ...
        <button
          ...
          className="flex items-center gap-3 px-4 py-2 hover:bg-gray-50 transition-colors cursor-pointer w-full text-left"
        >
          <div className="w-8 h-8 rounded-lg border border-red-400 bg-red-50 flex items-center justify-center text-red-500">
            <IoIosLogOut className="text-xl" />
          </div>
