...
export const GradingScalePill = ({ label, active, onClick }) => {
  ...
  switch (label) {
    case "A":
      pillColor = "bg-[#0B3D2E] text-white border-black hover:opacity-80";
      break;
    case "B":
      pillColor = "bg-[#1DB863] text-white border-green-500 hover:opacity-80";
      break;
    case "C":
      pillColor = "bg-[#F4D35E] text-white border-gray-500 hover:opacity-80";
      break;
    case "D":
      pillColor = "bg-[#FFB805] text-black border-yellow-500 hover:opacity-80";
      break;
    case "F":
