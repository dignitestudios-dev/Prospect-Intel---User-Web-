...
export default function ActiveFilters({
  ...
  return (
    <div className="w-full xl:w-[300px] p-6 pt-4 border-l-0 xl:border-l-2 border-gray-200 mb-2">
      {/* Header */}
      <div className="flex justify-between items-center mb-4 border-b border-gray-300 pb-4">
        ...
        <button
          ...
          className="text-md text-black bg-white p-1.5 px-4 rounded-lg font-extralight hover:text-blue-700"
        >
          Clear All
        </button>
      </div>
      ...
      <div className="divide-y divide-gray-100">
        ...
        <FilterSection title="Personal Character" defaultOpen={false}>
          <div className="grid grid-cols-3 sm:grid-cols-7 gap-2 sm:gap-7">
